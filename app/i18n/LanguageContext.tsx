...
const translations = {
  en: {
    ...
    problemPoint1: "Every year Uzbek companies lose 15–25% of their clients",
    problemPoint2: "No real-time analysis of client behavior and no timely reaction",
    problemPoint3: "Global tools (Amplitude, Gainsight, Intercom) cannot be used – Law ZRU-547 forbids exporting personal data outside Uzbekistan",
    problemPoint4: "One human analyst can handle only 80–100 clients per month",
    problemSummary: "Companies are losing revenue due to data sovereignty laws and limited human capacity",
    ourSolution: "Our Solution",
    solutionPoint1: "that processes and stores all data only inside Uzbekistan",
    solutionPoint2: "Tracks every client action in real time and predicts who will leave 15–30 days in advance",
    solutionPoint3: "Gives managers clear, personalized recommendations (\"do this today to keep this client\")",
    solutionPoint4: "Never acts automatically – the human manager stays in full control",
    solutionPoint5: "Understands local patterns: salary days (27–30th), Ramadan & Navruz behavior, regional differences, and instantly suggests the right action",
    ...
    roadmapCallToAction: "We're building the future of AI-powered customer insights, tailored specifically for the Uzbek market.",
    ...
    finalIdeaSubmissionDesc: "Final idea preparation and submission for AI500 Hackathon",
    activeMVPDevelopment: "Active MVP development",
    activeMVPDevelopmentDesc: "Data connectors, local AI core, dashboard, first recommendations",
    officialPresentation: "Official AI500 Hackathon presentation",
    officialPresentationDesc: "Presenting our working product to the judges and audience",
    publicLaunch: "Public launch (if we win)",
    publicLaunchDesc: "Onboarding of first 10–20 real clients",
    fiftyClients: "50 paying SMB clients",
    fiftyClientsDesc: "Expanding our client base to 50 small and medium businesses",
    certificationPilot: "Certification + first bank pilot",
    certificationPilotDesc: "Full certification by the Personal Data Agency + first bank pilot",
    twoHundredClients: "200+ clients across Uzbekistan",
    twoHundredClientsDesc: "Expanding our reach to over 200 clients nationwide",
    marketLeader: "Leader in customer-retention AI",
    marketLeaderDesc: "Becoming the recognized leader in AI-driven customer retention in Uzbekistan",
    ...
    teamLeaderRole: "Team Leader, Backend Developer",
    teamLeaderDesc: "Leading the technical architecture and backend development with expertise in scalable systems and AI integration.",
    fullstackRole: "Fullstack Developer",
    fullstackDesc: "Building seamless user experiences and robust full-stack solutions with modern web technologies.",
  ...
  uz: {
    ...
    roadmapCallToAction: "Biz AI kuchaytirilgan mijozlar haqidagi ma'lumotlar kelajagini qurmoqdamiz, aynan o'zbek bozori uchun moslashtirilgan.",
    ...
    finalIdeaSubmissionDesc: "AI500 Hackathon uchun yakuniy g'oya tayyorlash va topshirish",
    activeMVPDevelopment: "Faol MVP ishlab chiqish",
    activeMVPDevelopmentDesc: "Ma'lumotlar ulagichlari, mahalliy AI yadro, dashboard, birinchi tavsiyalar",
    officialPresentation: "Rasmiy AI500 Hackathon taqdimoti",
    officialPresentationDesc: "Ishlaydigan mahsulotimizni hakamlar va tomoshabinlarga taqdim etish",
    publicLaunch: "Ommaviy ishga tushirish (agar g‘olib bo‘lsak)",
    publicLaunchDesc: "Birinchi 10–20 haqiqiy mijozni ulash",
    fiftyClients: "50 ta to‘lovchi SMB mijoz",
    fiftyClientsDesc: "Mijozlar bazasini 50 ta kichik va o'rta biznesga kengaytirish",
    certificationPilot: "Sertifikatlash + birinchi bank piloti",
    certificationPilotDesc: "Shaxsiy ma'lumotlar agentligi tomonidan to'liq sertifikatlash + birinchi bank piloti",
    twoHundredClients: "O‘zbekiston bo‘ylab 200+ mijoz",
    twoHundredClientsDesc: "Bizning qamrovimizni butun mamlakat bo'ylab 200 dan ortiq mijozga kengaytirish",
    marketLeader: "Mijozlarni saqlash bo‘yicha AI yetakchisi",
    marketLeaderDesc: "O'zbekistonda AI orqali mijozlarni saqlash bo'yicha tan olingan yetakchi bo'lish",
    ...
    teamLeaderRole: "Jamoa rahbari, Backend dasturchi",
    teamLeaderDesc: "Texnik arxitektura va backend ishlab chiqishni boshqarish, masshtablanuvchan tizimlar va AI integratsiyasi bo'yicha tajriba bilan.",
    fullstackRole: "Fullstack dasturchi",
    fullstackDesc: "Mijoz tajribasi va zamonaviy web texnologiyalar bilan mustahkam full-stack yechimlarni qurish.",
    ...
    photo: "Rasm",
    yourImageHere: "Sizning rasmingiz shu yerda",
  },
} as const;
