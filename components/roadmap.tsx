...
const timelineItems = [
  {
    ...
    titleKey: "finalIdeaSubmission",
    descKey: "finalIdeaSubmissionDesc",
    icon: Calendar,
    status: "completed"
  },
  {
    ...
    titleKey: "activeMVPDevelopment",
    descKey: "activeMVPDevelopmentDesc",
    icon: Code,
    status: "current"
  },
  {
    ...
    titleKey: "officialPresentation",
    descKey: "officialPresentationDesc",
    icon: Presentation,
    status: "upcoming"
  },
  {
    ...
    titleKey: "publicLaunch",
    descKey: "publicLaunchDesc",
    icon: Rocket,
    status: "upcoming"
  },
  {
    ...
    titleKey: "fiftyClients",
    descKey: "fiftyClientsDesc",
    icon: Users,
    status: "upcoming"
  },
  {
    ...
    titleKey: "certificationPilot",
    descKey: "certificationPilotDesc",
    icon: Shield,
    status: "upcoming"
  },
  {
    ...
    titleKey: "twoHundredClients",
    descKey: "twoHundredClientsDesc",
    icon: TrendingUp,
    status: "upcoming"
  },
  {
    ...
    titleKey: "marketLeader",
    descKey: "marketLeaderDesc",
    icon: Trophy,
    status: "upcoming"
  },
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 border border-primary/30 rounded-full mb-6 backdrop-blur-sm">
            ...
            <span className="text-primary font-semibold text-sm uppercase tracking-wider">{t("developmentJourney")}</span>
          </div>
          <h2 className="text-6xl font-bold mb-6 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent">
            {t("ourRoadmap")} <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">{t("roadmap")}</span>
          </h2>
          <div className="inline-flex items-center gap-4 px-8 py-4 bg-card/50 backdrop-blur border border-primary/20 rounded-2xl mb-6">
            ...
            <div className="text-left">
              <div className="text-primary font-semibold text-lg">{t("currentStage")}</div>
              <div className="text-muted-foreground text-sm">{t("asOfNov2025")}</div>
            </div>
          </div>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            {t("roadmapDesc")}
            <span className="text-primary font-semibold"> {t("seeYouOn13December")}</span>
          </p>
        </div>
              ...
              return (
                ...
                >
                  <div className={`absolute top-1/2 transform -translate-y-1/2 w-96 ${
                    ...
                    <h3 className="text-xl font-bold mb-3 text-foreground leading-tight">{t(item.titleKey)}</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">{t(item.descKey)}</p>
                    ...
                    {item.status === "current" && (
                      <div className="inline-flex items-center gap-3 px-4 py-2 bg-primary/20 border border-primary/30 rounded-full">
                        ...
                        <span className="text-primary text-sm font-semibold">{t("inProgress")}</span>
                      </div>
                    )}
                  </div>
        ...
        <div className={`text-center mt-24 p-12 border-2 border-primary/30 rounded-3xl bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 backdrop-blur-2xl transition-all duration-1000 delay-1200 ${inView ? "translate-y-0 opacity-100 scale-100" : "translate-y-12 opacity-0 scale-95"}`}>
          <div className="max-w-2xl mx-auto">
            <h3 className="text-3xl font-bold text-foreground mb-6 bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">
              {t("transformRetention")}
            </h3>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              {t("roadmapCallToAction")}
            </p>
